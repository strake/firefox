...
class nsLookAndFeel final : public nsXPLookAndFeel {
 ...
 protected:
  ...
  // Cached colors
  nscolor mInfoBackground = kBlack;
  nscolor mInfoText = kWhite;
  nscolor mMenuBackground = kBlack;
  nscolor mMenuBarText = kWhite;
  nscolor mMenuBarHoverText = kWhite;
  nscolor mMenuText = kWhite;
  nscolor mMenuTextInactive = kBlack;
  nscolor mMenuHover = kBlack;
  nscolor mMenuHoverText = kWhite;
  nscolor mButtonDefault = kBlack;
  nscolor mButtonText = kWhite;
  nscolor mButtonHoverText = kWhite;
  nscolor mButtonHoverFace = kBlack;
  nscolor mButtonActiveText = kWhite;
  nscolor mFrameOuterLightBorder = kWhite;
  nscolor mFrameInnerDarkBorder = kBlack;
  nscolor mOddCellBackground = kBlack;
  nscolor mNativeHyperLinkText = kWhite;
  nscolor mComboBoxText = kWhite;
  nscolor mComboBoxBackground = kBlack;
  nscolor mFieldText = kWhite;
  nscolor mFieldBackground = kBlack;
  nscolor mMozWindowText = kWhite;
  nscolor mMozWindowBackground = kBlack;
  nscolor mMozWindowActiveBorder = kWhite;
  nscolor mMozWindowInactiveBorder = kWhite;
  nscolor mMozWindowInactiveCaption = kBlack;
  nscolor mMozCellHighlightBackground = kBlack;
  nscolor mMozCellHighlightText = kWhite;
  nscolor mTextSelectedText = kWhite;
  nscolor mTextSelectedBackground = kBlack;
  nscolor mMozScrollbar = kBlack;
  nscolor mInfoBarText = kWhite;
  ...
  bool mSystemUsesDarkTheme = true;
